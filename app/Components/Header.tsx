  ...
  return (
    <div className="bg-blue-600 text-lime-50 relative">
      <div className="container py-5 flex items-center justify-between gap-1">
        ...
        <ul className={`navigation_area flex flex-col transition-all  lg:lg:translate-x-0 absolute top-0 left-0 min-h-screen w-96 bg-black z-10 lg:relative lg:teft-auto lg:flex-row lg:bg-transparent lg:min-h-0 lg:w-auto lg:gap-3 lg:translate-x-{0} ${navigationAreaStyle}`}>
          <li>
